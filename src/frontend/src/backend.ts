...
export class Backend implements backendInterface {
    ...
    async getLevelConfig(arg0: bigint): Promise<{
        targetScore: bigint;
        gridSize: bigint;
    }> {
        if (this.processError) {
            try {
                const result = await this.actor.getLevelConfig(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getLevelProgress(arg0: bigint): Promise<LevelProgress> {
        if (this.processError) {
            try {
                const result = await this.actor.getLevelProgress(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getTopPlayers(): Promise<Array<PlayerProfile>> {
        if (this.processError) {
            try {
    ...
    async resetAllPlayerData(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.resetAllPlayerData();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async saveLevelProgress(arg0: bigint, arg1: LevelProgress): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.saveLevelProgress(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async savePlayerProfile(arg0: PlayerProfile): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.savePlayerProfile(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
